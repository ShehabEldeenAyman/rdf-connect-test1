...
import { replicateLDES } from "../lib/client.js";
import { intoConfig } from "../lib/config.js";
import { Command, Option } from "commander";
import { Writer } from "n3";
import { enhanced_fetch } from "../lib/utils.js";
import { empty_condition, parse_condition } from "../lib/condition/index.js";
...
program
    .arguments("<url>")
    .addOption(new Option("-o --ordered <ordered>", "emit members in order")
    ...
    // )
    .option("--condition <condition_file>", "turtle file including the conditions for extracting a member")
    ...
    .option("--concurrent <requests>", "Allowed amount of concurrent HTTP request to the same domain", "5")
    .option("--retry-count <retry>", "Retry count per failing request (0 is infinite)", "3")
